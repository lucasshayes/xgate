...
def xception_block(inputs, num_filters=32, k_size=3, middle_blocks=2, downsample=False, name="xception"):
    ...
    x = layers.Conv1D(
        ...
        kernel_initializer="he_normal", kernel_constraint=k.constraints.max_norm(2),
    ...
    x = layers.SeparableConv1D(
        ...
        depthwise_constraint=k.constraints.max_norm(2),
        pointwise_constraint=k.constraints.max_norm(2),
